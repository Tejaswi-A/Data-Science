...
if __name__ == '__main__':
    ...
    symptoms = {'itching': 0, 'skin_rash': 1, 'nodal_skin_eruptions': 0, 'continuous_sneezing': 0,
    ...
    class_probabilities = np.array(clf.predict_proba(df_test).flat)  # Assuming a single input for prediction
    ...
    print(f"Predicted Disease: {result}", formatted_output)
